...
- Mini theme crossing uses a synchronous `localStorage` settings handoff because main and mini are separate WebViews/Zustand stores; disk Store is retained for persistence but no longer carries the immediate cross-window handoff alone.
