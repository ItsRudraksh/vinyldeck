...
- Mini theme crossing bug root cause: localStorage handoff was wrong for separate WebViews and could poison persistent settings with stale/default Noir. Desktop source of truth is now only Tauri Store; settings flush before mini opens; legacy localStorage handoff is cleared and not read.
