...
V1 status: the current repo is the V1 development baseline. Backend Phase 10 hardening has passed automated verification and the user approved the real Spotify sync fix. Phase 11 Windows distribution/install validation is intentionally on hold for a later release pass.
...
- React visual engine with five cinematic themes: Noir, Glass, Aurora, Vapor, Paper
