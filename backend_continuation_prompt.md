...
- B10.1 is complete: Rust poller regression covers cold no-media, media starts after app, media app exits, repeated no-media silence, media restart, and session switch between players. Next work: B10.2 metadata/artwork edge cases.
